...
const App = () => {
  ...
  const init = async () => {
    ...
    if (hash && hash.includes('access_token')) {
      ...
      try {
        // Supabase automatically detects and processes the hash fragment
        ...
        if (error) {
          ...
          if (fullUser) {
            // Clean up URL FIRST (remove hash fragment to prevent re-triggering)
        ...
        {isEditing ? (
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              >
                {extraCreditEnabled ? 'â­Â Extra Credit: ON' : 'â­Â Extra Credit: OFF'}
              </button>
                  ...
                  <div key={course.id} className="flex justify-between items-center p-4 border-2 rounded-xl">
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-600">
                        ...
                        <span>â€“ {course.questions?.length || 0} questions</span>
