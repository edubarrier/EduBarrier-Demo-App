              ...
              <button
                onClick={async () => {
                  ...
                  try {
                    ...
                    // Re-enable button after 1.2 seconds
                    setTimeout(() => setIsProcessingLock(false), 1200);
                  }
                }}
              ...
              <button
                onClick={async () => {
                  ...
                  try {
                    ...
                    // Re-enable button after 1.2 seconds
                    setTimeout(() => setIsProcessingTime(false), 1200);
                  }
                }}
              ...
              <button
                onClick={async () => {
                  ...
                  try {
                    ...
                    // Re-enable button after 1.2 seconds
                    setTimeout(() => setIsProcessingCredit(false), 1200);
                  }
                }}
