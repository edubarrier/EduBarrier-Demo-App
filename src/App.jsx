                        ...
                        {dayAssignments.map(a => {
                          ...
                          return (
                            <div key={a.id} className="flex items-center justify-between p-4 bg-gradient-to-r from-teal-50 to-emerald-50 rounded-xl border-2 border-teal-100">
                                ...
                                <div className="flex gap-2 text-sm">
                                  ...
                                  {a.status === 'completed' && a.completed_at && (
                                    <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full font-medium">
                                      Completed: {new Date(a.completed_at).toLocaleTimeString('en-US', { 
                                        hour: 'numeric', 
                                        minute: '2-digit' 
                                      })}
                                    </span>
                              ...
                              <button
                                onClick={() => deleteAssignment(a.id)}
                                className="ml-4 text-red-500 hover:text-white bg-red-50 hover:bg-red-500 p-3 rounded-xl transition-all"
                                title="Delete assignment"
                              >
                                <XCircle size={20} />
                              </button>
