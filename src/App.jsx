                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Quick">Quick (ÃƒÂ¢Ã¢â‚¬Â°Ã‚Â¤20 min)</option>
            ...
            <div className="bg-white rounded-3xl shadow-lg p-6">
              ...
              <div className="flex flex-col items-center mb-8">
                <div className="text-center mb-6">
                  <span className="text-8xl mb-2 block">{barrierStatus?.is_active ? '🛡️' : '🔔'}</span>
              ...
              <div className="space-y-6">
                ...
                <div className="border-b pb-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Ãƒâ€šÃ‚Â© 2025 EduBarrier Inc. All rights reserved.</p>
                    <button 
                      onClick={() => {
...
const AdminView = ({ user, onLogout }) => {
  ...
  const checkSystemStatus = async () => {
    console.log('ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â Starting system status check...');
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.storage.status === 'online' ? '\u{2713} Online' : 
                     systemStatus.storage.status === 'warning' ? 'ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Warning' : 
                     systemStatus.storage.status === 'offline' ? 'ÃƒÂ¢Ã¢â‚¬ÂºÃ¢â‚¬Â Offline' : '\u{23F3} Checking'}
                  </span>
                </div>
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.courses.status === 'online' ? '\u{2713} Online' : 
                     systemStatus.courses.status === 'warning' ? 'ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Warning' : 
                     systemStatus.courses.status === 'offline' ? 'ÃƒÂ¢Ã¢â‚¬ÂºÃ¢â‚¬Â Offline' : '\u{23F3} Checking'}
                  </span>
                </div>
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.users.status === 'online' ? '\u{2713} Online' : 
                     systemStatus.users.status === 'warning' ? 'ÃƒÂ¢Ã…Â¡Ã‚Â ÃƒÂ¯Ã‚Â¸Ã‚Â Warning' : 
                     systemStatus.users.status === 'offline' ? 'ÃƒÂ¢Ã¢â‚¬ÂºÃ¢â‚¬Â Offline' : '\u{23F3} Checking'}
                  </span>
                </div>
              </div>
            </div>
