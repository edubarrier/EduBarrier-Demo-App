...
const ParentView = ({ user, onLogout }) => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(loadFamilyHeartbeats, 5000);
  ...
  const checkHeartbeatStatus = (lastHeartbeat) => {
    ...
    // Consider offline if no heartbeat for 60 seconds (2 missed cycles)
  ...
  const BarrierStatusBar = ({ barrierStatus, familyHeartbeats, checkHeartbeatStatus }) => {
    ...
    let borderColor, bgColor, textColor, statusText, iconText;
    
    if (!isActive) {
      borderColor = 'border-gray-300';
      bgColor = 'bg-white';
      textColor = 'text-gray-600';
      statusText = 'Barrier Status: Not Enabled';
      iconText = '🔓';
    } else if (hasAlert) {
      borderColor = 'border-red-500';
      bgColor = 'bg-gradient-to-r from-red-50 to-pink-50';
      textColor = 'text-red-600';
      statusText = 'Barrier Status: Alert - App Closed';
      iconText = '🚨';
    } else {
      borderColor = 'border-green-500';
      bgColor = 'bg-gradient-to-r from-green-50 to-emerald-50';
      textColor = 'text-green-600';
      statusText = 'Barrier Status: Enabled';
      iconText = '🛡️';
    }
    
    return (
      <div className={`mx-4 mt-4 mb-2 p-3 border-2 ${borderColor} ${bgColor} rounded-xl flex items-center gap-3 ${hasAlert ? 'animate-pulse' : ''}`}>
