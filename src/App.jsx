    ...
    if (hash && hash.includes('access_token')) {
      ...
      try {
        ...
        if (data?.session?.user) {
          console.log('✅ Email confirmed! User:', data.session.user.email);
          ...
          if (fullUser) {
            ...
            // Set success message
            setSuccessMessage('✅ Email confirmed! Welcome to EduBarrier!');
                    ...
                    <div key={course.id} className="border-2 border-gray-200 rounded-2xl p-6 hover:border-teal-300 hover:shadow-lg transition-all">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4 text-xs">
                        ...
                        <span className="bg-orange-100 text-orange-700 px-3 py-1 rounded-full">
                          ⏱ï¸ {course.estimatedTime || course.estimated_time || 30} min
                        </span>
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.storage.status === 'online' ? '✓ Online' : 
                     systemStatus.storage.status === 'warning' ? '—ï¸ Warning' : 
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.courses.status === 'online' ? '✓ Online' : 
                     systemStatus.courses.status === 'warning' ? '—ï¸ Warning' : 
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.users.status === 'online' ? '✓ Online' : 
                     systemStatus.users.status === 'warning' ? '—ï¸ Warning' : 
                  ...
                  <div key={course.id} className="flex justify-between items-center p-4 border-2 rounded-xl">
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-600">
                        ...
                        <span>⏱ï¸ {course.estimatedTime || course.estimated_time || 30} min</span>
