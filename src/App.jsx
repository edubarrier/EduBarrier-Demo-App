              ...
              <div className="space-y-6">
                ...
                <div className="border-b pb-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Ã‚Â© 2025 EduBarrier Inc. All rights reserved.</p>
                    <button 
                      onClick={() => {
...
const AdminView = ({ user, onLogout }) => {
  ...
  const checkSystemStatus = async () => {
    console.log('Ã°Å¸â€Â Starting system status check...');
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.storage.status === 'online' ? '\u{2713} Online' : 
                     systemStatus.storage.status === 'warning' ? 'Ã¢Å¡Â Ã¯Â¸Â Warning' : 
                     systemStatus.storage.status === 'offline' ? 'Ã¢â€ºâ€ Offline' : '\u{23F3} Checking'}
                  </span>
                </div>
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.courses.status === 'online' ? '\u{2713} Online' : 
                     systemStatus.courses.status === 'warning' ? 'Ã¢Å¡Â Ã¯Â¸Â Warning' : 
                     systemStatus.courses.status === 'offline' ? 'Ã¢â€ºâ€ Offline' : '\u{23F3} Checking'}
                  </span>
                </div>
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.users.status === 'online' ? '\u{2713} Online' : 
                     systemStatus.users.status === 'warning' ? 'Ã¢Å¡Â Ã¯Â¸Â Warning' : 
                     systemStatus.users.status === 'offline' ? 'Ã¢â€ºâ€ Offline' : '\u{23F3} Checking'}
                  </span>
                </div>
              </div>
            </div>
