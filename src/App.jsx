              ...
              <div className="space-y-6">
                ...
                <div className="border-b pb-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">© 2025 EduBarrier Inc. All rights reserved.</p>
                    <button 
                      onClick={() => {
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.storage.status === 'online' ? '\u{2713} Online' : 
                     systemStatus.storage.status === 'warning' ? '⚠️ Warning' : 
                     systemStatus.storage.status === 'offline' ? '⛔ Offline' : '\u{23F3} Checking'}
                  </span>
                </div>
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.courses.status === 'online' ? '\u{2713} Online' : 
                     systemStatus.courses.status === 'warning' ? '⚠️ Warning' : 
                     systemStatus.courses.status === 'offline' ? '⛔ Offline' : '\u{23F3} Checking'}
                  </span>
                </div>
                ...
                <div className={`flex justify-between items-center p-3 rounded-lg ${
                  ...
                  <span className={`font-semibold ${
                    ...
                    {systemStatus.users.status === 'online' ? '\u{2713} Online' : 
                     systemStatus.users.status === 'warning' ? '⚠️ Warning' : 
                     systemStatus.users.status === 'offline' ? '⛔ Offline' : '\u{23F3} Checking'}
                  </span>
                </div>
              </div>
            </div>
