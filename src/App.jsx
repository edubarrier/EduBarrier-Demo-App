    ...
    if (email === 'demo@parent.com' && password === 'demo') {
      try {
        ...
        if (!demoParent) {
          ...
          console.log('Demo family created with code:', householdCode);
        }
        ...
        if (!demoChild) {
          ...
          if (!demoParent) {
            ...
            demoChild = { 
              ...
              role: 'child', 
              name: 'Demo Child', 
              familyId: demoParent.familyId
            };
            await db.createUser(demoChild);
            
            // Add child to family
            const family = await db.getFamily(demoParent.familyId);
            if (family && !family.children.includes('demo_child')) {
              family.children.push('demo_child');
